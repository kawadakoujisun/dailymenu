...
<?php
    ...
    if ($dateSrc != null)
    {
        ...
        $y = App\DisplayUtil\DisplayNumberUtil::getDisplayNumberString(date('Y', $dateTimestamp));
        $m = App\DisplayUtil\DisplayNumberUtil::getDisplayNumberString(date('n', $dateTimestamp));
        $d = App\DisplayUtil\DisplayNumberUtil::getDisplayNumberString(date('j', $dateTimestamp));
